...
myVertexType vertices[81] =
{   //   X      Y    Z    R   G     B
	//FISH
	{ -0.1f, -0.0f, 0.f, 0.4f, 0.4f, 1.f }, // vertex 0
	{  0.25f, -0.5f, 0.f, 0.4f, 0.4f, 1.f },
	{  0.25f,  0.5f, 0.f, 0.4f, 0.4f, 1.f },

	{ -0.6f, -0.0f, 0.f, 1.f, 1.f, 0.f }, // vertex 0
	{  0.0f, -0.6f, 0.f, 1.f, 1.f, 0.f },
	{  0.0f,  0.6f, 0.f, 1.f, 1.f, 0.f },

	{ -0.6f, -0.0f,   0.f, 0.f, 0.93f, 0.f }, // vertex 0
	{ -0.37f, -0.231f, 0.f, 0.f, 0.93f, 0.f },
	{ -0.37f,  0.231f, 0.f, 0.f, 0.93f, 0.f },

	{ -0.52f,   0.0f,  0.f, 0.78f, 0.47f, 0.3f }, // 
	{ -0.47f,  0.05f, 0.f, 0.78f, 0.47f, 0.3f },
	{ -0.47f, -0.05f, 0.f, 0.78f, 0.47f, 0.3f },

	{ -0.3f,   0.0f,  0.f, 0.93f, 0.19f, 0.65f }, // 
	{ -0.06f,  0.3f, 0.f, 0.93f, 0.19f, 0.65f },
	{ -0.06f, -0.3f, 0.f, 0.93f, 0.19f, 0.65f },

	{ -0.15f,   0.0f,  0.f, 0.93f, 0.48f, 0.91f }, // 
	{ -0.02f,  0.2f, 0.f, 0.93f, 0.48f, 0.91f },
	{ -0.02f, -0.2f, 0.f, 0.93f, 0.48f, 0.91f },

	//SEAWEED

	{ -1.5f,  -0.9f,  0.f, 0.4f, 0.67f, 0.38f }, // 
	{ -1.4f,  -1.f, 0.f, 0.4f, 0.67f, 0.38f },
	{ -1.3f,  -0.9f, 0.f, 0.4f, 0.67f, 0.38f },

	{ -1.5f,  -0.85f,  0.f, 0.4f, 0.8f, 0.8f }, // 
	{ -1.4f,  -0.95f, 0.f, 0.4f, 0.8f, 0.8f },
	{ -1.3f,  -0.85f, 0.f, 0.4f, 0.8f, 0.8f },

	{ -1.5f,  -0.8f,  0.f, 0.4f, 0.67f, 0.38f }, // 
	{ -1.4f,  -0.9f, 0.f, 0.4f, 0.67f, 0.38f },
	{ -1.3f,  -0.8f, 0.f, 0.4f, 0.67f, 0.38f },

	{ -1.5f,  -0.75f,  0.f, 0.4f, 0.8f, 0.8f }, // 
	{ -1.4f,  -0.85f, 0.f, 0.4f, 0.8f, 0.8f },
	{ -1.3f,  -0.75f, 0.f, 0.4f, 0.8f, 0.8f },

	{ -1.5f,  -0.7f,  0.f, 0.4f, 0.67f, 0.38f }, // 5th
	{ -1.4f,  -0.8f, 0.f, 0.4f, 0.67f, 0.38f },
	{ -1.3f,  -0.7f, 0.f, 0.4f, 0.67f, 0.38f },

	{ -1.5f,  -0.65f,  0.f, 0.4f, 0.8f, 0.8f }, // 
	{ -1.4f,  -0.75f, 0.f, 0.4f, 0.8f, 0.8f },
	{ -1.3f,  -0.65f, 0.f, 0.4f, 0.8f, 0.8f },

	{ -1.5f,  -0.6f,  0.f, 0.4f, 0.67f, 0.38f }, // 
	{ -1.4f,  -0.7f, 0.f, 0.4f, 0.67f, 0.38f },
	{ -1.3f,  -0.6f, 0.f, 0.4f, 0.67f, 0.38f },

	{ -1.5f,  -0.55f,  0.f, 0.4f, 0.8f, 0.8f }, // 8th = 42 points = 14 vertexes
	{ -1.4f,  -0.65f, 0.f, 0.4f, 0.8f, 0.8f },
	{ -1.3f,  -0.55f, 0.f, 0.4f, 0.8f, 0.8f },

	//Long seaweed

	{ -1.2f,  -0.9f,  0.f, 0.4f, 0.67f, 0.38f }, // 
	{ -1.1f,  -1.0f, 0.f, 0.4f, 0.67f, 0.38f },
	{ -1.0f,  -0.9f, 0.f, 0.4f, 0.67f, 0.38f },

	{ -1.2f,  -0.8f,  0.f, 0.4f, 0.8f, 0.8f }, // 
	{ -1.1f,  -0.9f, 0.f, 0.4f, 0.8f, 0.8f },
	{ -1.0f,  -0.8f, 0.f, 0.4f, 0.8f, 0.8f },

	{ -1.2f,  -0.7f,  0.f, 0.4f, 0.67f, 0.38f }, // 
	{ -1.1f,  -0.8f, 0.f, 0.4f, 0.67f, 0.38f },
	{ -1.0f,  -0.7f, 0.f, 0.4f, 0.67f, 0.38f },

	{ -1.2f,  -0.6f,  0.f, 0.4f, 0.8f, 0.8f }, // 
	{ -1.1f,  -0.7f, 0.f, 0.4f, 0.8f, 0.8f },
	{ -1.0f,  -0.6f, 0.f, 0.4f, 0.8f, 0.8f },

	{ -1.2f,  -0.5f,  0.f, 0.4f, 0.67f, 0.38f }, // 
	{ -1.1f,  -0.6f, 0.f, 0.4f, 0.67f, 0.38f },
	{ -1.0f,  -0.5f, 0.f, 0.4f, 0.67f, 0.38f },

	{ -1.2f,  -0.4f,  0.f, 0.4f, 0.8f, 0.8f }, // 
	{ -1.1f,  -0.5f, 0.f, 0.4f, 0.8f, 0.8f },
	{ -1.0f,  -0.4f, 0.f, 0.4f, 0.8f, 0.8f },

	{ -1.2f,  -0.3f,  0.f, 0.4f, 0.67f, 0.38f }, // 
	{ -1.1f,  -0.4f, 0.f, 0.4f, 0.67f, 0.38f },
	{ -1.0f,  -0.3f, 0.f, 0.4f, 0.67f, 0.38f },

	{ -1.2f,  -0.2f,  0.f, 0.4f, 0.8f, 0.8f }, // 
	{ -1.1f,  -0.3f, 0.f, 0.4f, 0.8f, 0.8f },
	{ -1.0f,  -0.2f, 0.f, 0.4f, 0.8f, 0.8f },

	{ -1.2f,  -0.1f,  0.f, 0.4f, 0.67f, 0.38f }, // 
	{ -1.1f,  -0.2f, 0.f, 0.4f, 0.67f, 0.38f },
	{ -1.0f,  -0.1f, 0.f, 0.4f, 0.67f, 0.38f },

	{ -1.2f,  0.f,  0.f, 0.4f, 0.8f, 0.8f }, // 
	{ -1.1f,  -0.1f, 0.f, 0.4f, 0.8f, 0.8f },
	{ -1.0f,  0.f, 0.f, 0.4f, 0.8f, 0.8f },

	{ -1.2f,  0.1f,  0.f, 0.4f, 0.67f, 0.38f }, // 
	{ -1.1f,  0.f, 0.f, 0.4f, 0.67f, 0.38f },
	{ -1.0f,  0.1f, 0.f, 0.4f, 0.67f, 0.38f },
